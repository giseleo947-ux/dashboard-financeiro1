...
# ✔ CORRETO (remove passivo compensatório)
...
fig3.add_trace(go.Bar(name="Despesas", x=["Custos"], y=[despesas_adm]))
...
if endividamento_real < endividamento_total:
    st.info("Endividamento real menor (efeito do passivo compensatório)")

if cmv_sobre_custos > 70:
    st.warning("CMV muito alto dentro dos custos")
